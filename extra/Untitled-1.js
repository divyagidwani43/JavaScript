...
if (john.BMI > mark.BMI) {
    console.log(`${john.fullName} has BMI ${john.BMI} is higher than ${mark.fullName}'s ${mark.BMI}!`);
} else console.log(`${mark.fullName} has BMI ${mark.BMI} is higher than ${john.fullName}'s ${john.BMI}!`);
