...
for (let i = 1; i < players1.length; i++) {
    const players = players1[i];
    fieldPlayers.push(players)
}
...
console.log(team11, draw2, team12)
...
console.log('had to watch solution');
const printGoals = function (...playerName) {
    // console.log(...playerName)
    console.log(`${playerName.length} goals are scored`);
}
